...
fun chooseLongestChaoticWord(inputName: String, outputName: String) {
    ...
    for (l in file) {
        if (l.toLowerCase().toSet().size == l.toLowerCase().length) {
            if (mLen < l.length) {
                mLen = l.length
                res.clear()
                res.add(l)
            } else if (mLen == l.length) res.add(l)
        }
